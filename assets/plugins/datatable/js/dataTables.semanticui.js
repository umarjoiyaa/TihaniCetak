...
!(function (n) {
    ...
    function Se(e) {
        var t = e.oLanguage,
            n = t.sZeroRecords,
            a = te(e);
            if (e.iDraw == 1 && ("ajax" === a || "ssp" === a)) {
                n = t.sEmptyTable;
            } else if (e.iDraw <= 1 && ("ajax" === a || "ssp" === a)){
                n = t.sLoadingRecords;
            }
            else if (t.sEmptyTable && e.fnRecordsTotal() === 0) {
                // Set n to t.sEmptyTable only if e.iDraw is 1
                n = e.iDraw === 1 ? t.sEmptyTable : n;
            }
        return (
