$(document).ready(function () {
    ...
    $('.datatable').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'text.sale_order.order_no',
                name: 'text.sale_order.order_no',
            },
            {
                data: 'text.sale_order.customer',
                name: 'text.sale_order.customer',
            },
            {
                data: 'text.sale_order.kod_buku',
                name: 'text.sale_order.kod_buku',
            },
            {
                data: 'text.sale_order.description',
                name: 'text.sale_order.description',
            },
            {
                data: 'text.kuantiti_waste',
                name: 'text.kuantiti_waste',
            },
            {
                data: 'machine',
                name: 'machine',
