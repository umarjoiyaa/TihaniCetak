...
return new class extends Migration
{
    ...
    {
        Schema::create('laporan_proses_penjilidan_saddles', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('pembantu_text')->nullable();
    ...
    {
        Schema::dropIfExists('laporan_proses_penjilidan_saddles');
    }
};
