...
return new class extends Migration
{
    ...
    {
        Schema::create('laporan_pemeriksaan_kualiti_penjilidan_saddles', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('so_id')->nullable();
            $table->foreign('so_id')->references('id')->on('sale_orders')->nullable();
            ...
            $table->foreign('created_by', 'fk_created_by')->references('id')->on('users')->nullable();
            $table->softDeletes();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('laporan_pemeriksaan_kualiti_penjilidan_saddles');
    }
};
