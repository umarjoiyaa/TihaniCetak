...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sale_orders', function (Blueprint $table) {
            ...
            $table->string('approved_by_date2')->nullable();
            $table->string('approved_by_user2')->nullable();
            $table->string('approved_by_designation2')->nullable();
            $table->string('approved_by_department2')->nullable();
            $table->string('approved_by_date3')->nullable();
            $table->string('approved_by_user3')->nullable();
            $table->string('approved_by_designation3')->nullable();
            $table->string('approved_by_department3')->nullable();
