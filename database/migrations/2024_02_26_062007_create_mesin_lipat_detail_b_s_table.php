...
return new class extends Migration
{
    ...
    {
        Schema::create('mesin_lipat_detail_b_s', function (Blueprint $table) {
            $table->id();
            $table->string('mesin_lipat_detail_id')->nullable();
            $table->string('section_no')->nullable();
            $table->string('last_fold')->nullable();
    ...
    {
        Schema::dropIfExists('mesin_lipat_detail_b_s');
    }
};
