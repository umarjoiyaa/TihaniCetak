...
class ProsesPencetakanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $proses_pencetakan->seksyen_no = $request->seksyen_no == null ? 0 : $request->seksyen_no ;
        $proses_pencetakan->mesin = $request->mesin;
        $proses_pencetakan->jenis = $request->jenis;
        $proses_pencetakan->side = $request->side;

        $proses_pencetakan->b_1 = $request->b_1 == null ? '' : $request->b_1;
        $proses_pencetakan->b_2 = $request->b_2 == null ? '' : $request->b_2;
        $proses_pencetakan->b_3 = $request->b_3 == null ? '' : $request->b_3;
        $proses_pencetakan->b_4 = $request->b_4 == null ? '' : $request->b_4;
        $proses_pencetakan->b_5 = $request->b_5 == null ? '' : $request->b_5;
        $proses_pencetakan->b_6 = $request->b_6 == null ? '' : $request->b_6;
        $proses_pencetakan->b_7 = $request->b_7 == null ? '' : $request->b_7;
        $proses_pencetakan->b_8 = $request->b_8 == null ? '' : $request->b_8;
        $proses_pencetakan->b_9 = $request->b_9 == null ? '' : $request->b_9;
        $proses_pencetakan->b_10 = $request->b_10 == null ? '' : $request->b_10;
        $proses_pencetakan->b_11 = $request->b_11 == null ? '' : $request->b_11;
        $proses_pencetakan->b_12 = $request->b_12 == null ? '' : $request->b_12;
        $proses_pencetakan->b_13 = $request->b_13 == null ? '' : $request->b_13;
        $proses_pencetakan->b_14 = $request->b_14 == null ? '' : $request->b_14;
        $proses_pencetakan->b_15 = $request->b_15 == null ? '' : $request->b_15;
        $proses_pencetakan->b_16 = $request->b_16 == null ? '' : $request->b_16;
        $proses_pencetakan->b_17 = $request->b_17 == null ? '' : $request->b_17;
        $proses_pencetakan->b_18 = $request->b_18 == null ? '' : $request->b_18;
