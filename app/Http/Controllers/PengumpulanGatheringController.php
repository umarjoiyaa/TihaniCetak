...
class PengumpulanGatheringController extends Controller
{
    ...
    public function approve_approve(Request $request, $id){
        ...
        $pengumpulan_gathering->verified_by_designation = (Auth::user()->designations != null) ? Auth::user()->designations->name : 'not assign';
        $pengumpulan_gathering->verified_by_department = (Auth::user()->departments != null) ? Auth::user()->departments->name : 'not assign';
        $pengumpulan_gathering->save();
