...
class LaporanProsesLipatController extends Controller
{
    ...
    public function approve_approve(Request $request, $id){
        ...
        $laporan_proses_lipat->verified_by_designation = (Auth::user()->designations != null) ? Auth::user()->designations->name : 'not assign';
        $laporan_proses_lipat->verified_by_department = (Auth::user()->departments != null) ? Auth::user()->departments->name : 'not assign';
        $laporan_proses_lipat->save();
