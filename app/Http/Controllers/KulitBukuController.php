...
class KulitBukuController extends Controller
{
    ...
    public function approve_approve(Request $request, $id){
        ...
        $kulit_buku->verified_by_designation = (Auth::user()->designations != null) ? Auth::user()->designations->name : 'not assign';
        $kulit_buku->verified_by_department = (Auth::user()->departments != null) ? Auth::user()->departments->name : 'not assign';
        $kulit_buku->save();
