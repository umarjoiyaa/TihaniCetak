...
class Helper
{
    ...
    public static function getpermissions($permissions)
    {
        ...
        $wms_job_sheets = [
            ...
            'LAPORAN PEMERIKSAAN AKHIR, PEMBUNGKISAN DAN PENGHANTARAN KE STOR' => [
                ...
                'LAPORAN PEMERIKSAAN AKHIR, PEMBUNGKISAN DAN PENGHANTARAN KE STOR VerifyQC',
                'LAPORAN PEMERIKSAAN AKHIR, PEMBUNGKISAN DAN PENGHANTARAN KE STOR TransferToStore',
                'LAPORAN PEMERIKSAAN AKHIR, PEMBUNGKISAN DAN PENGHANTARAN KE STOR ReceiveByStore',
            ],
