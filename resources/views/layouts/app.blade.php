                                                    ...
                                                    <ul>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-12 col-xs-12 link-list">
                                                                ...
                                                                <li aria-haspopup="true"><a href="{{route('laporan_proses_penjilidan')}}" class="slide-item"><iconify-icon icon="ph:arrow-square-right" width="17"  style="color: #a41843"></iconify-icon>Laporan Proses Penjilidan  <br> (Perfect Bind)</a></li>
