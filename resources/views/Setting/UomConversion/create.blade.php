    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('uom_conversion.store') }}" method="post">
                        @csrf
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="control-group form-group">
                                    ...
                                    <select name="from" class="form-select" id="from">
                                        ...
                                        @foreach ($uoms as $uom)
                                            <option value="{{ $uom->id }}" @selected(old('from') == $uom->id)>
                                                {{ $uom->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="control-group form-group">
                                    ...
                                    <select name="to" class="form-select" id="to">
                                        <option value="" disabled selected>Select any option</option>
                                        @foreach ($uoms as $uom)
                                            <option value="{{ $uom->id }}" @selected(old('to') == $uom->id)>
                                                {{ $uom->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="control-group form-group">
                                    ...
                                    <input type="number" class="form-control required" name="base_value"
                                        value="{{ old('base_value') }}" placeholder="Base Value">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="control-group form-group">
                                    ...
                                    <input type="number" class="form-control required" name="conversion_ratio"
                                        value="{{ old('conversion_ratio') }}" placeholder="Conversion Ratio">
                                </div>
                            </div>
                        </div>
