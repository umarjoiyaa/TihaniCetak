                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="phone_no" id="" class="form-control"
                                        value="{{old('phone_no')}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="designation" class="form-select form-control">
                                        ...
                                        <option value="{{ $designation->id }}"
                                            @selected(old('designation')==$designation->id)>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="department" class="form-select form-control">
                                        ...
                                        <option value="{{ $department->id }}" @selected(old('department')==$department->
                                            id)>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="role[]" class="form-select" multiple>
                                        ...
                                        <option value="{{ $role->id }}" @if (old('role')) {{ in_array($role->id,
                                            old('role')) ? 'selected' : '' }} @endif>
                                            {{ $role->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
