            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('area_shelf.create') }}" class="btn btn-primary  mb-3">Create</a>
                    </div>
...
@push('custom-scripts')
    <script>
        var data = "{{ route('area_shelf.data') }}";
    </script>
    <script src="{{ asset('assets/js/custom/settings/AreaShelf/index.js') }}"></script>
@endpush
