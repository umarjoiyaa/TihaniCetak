    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5><b>Manage Transfer</b></h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{route('manage_transfer.create')}}"  class="btn btn-primary float-right">Create</a>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12">
...
@push('custom-scripts')
    <script>
        var data = "{{route('manage_transfer.data')}}";
    </script>
    <script src="{{ asset('assets/js/custom/wms/ManageTransfer/index.js') }}"></script>
@endpush
