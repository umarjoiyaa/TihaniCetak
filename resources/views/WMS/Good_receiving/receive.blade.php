...
<div class="modal fade " id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="width:1200px; margin-left:-340px;">
        ...
        <div class="modal-content" style="width:1200px; margin-left:-340px;">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <hr style="width:100%; color:#000; opacity:1; height:2px;">
                </div>
                ...
                <table class="table mt-2 w-100" id="example1">
                        ...
                        <tbody>
                            <tr class="text-center">
                                ...
                                <td><input type="text" readonly name="" id="" class="form-control"></td>
