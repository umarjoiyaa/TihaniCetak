                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="Based User Login" readonly name="" id=""
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4 mt-3">
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly placeholder="User Input" name="" id=""
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly placeHolder="userInput" name="" id=""
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-8"><input type="text" readonly placeholder="select Customers"
                                            name="" id="" class="form-control"></div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><button class="btn btn-primary" data-toggle="modal"
                                                        data-target="#staticBackdrop1">+</button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
