...
@section('content')
    <form action="{{ route('stock_in.update', $stock_in->id) }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <select name="sale_order" data-id="{{ $stock_in->sale_order_id ?? $stock_in->sale_order_other }}"
                                                id="sale_order" class="form-control">
                                                <option value="{{ $stock_in->sale_order_id ?? $stock_in->sale_order_other }}" selected
                                                    style="color: black; !important">
                                                    {{ $stock_in->sale_order->order_no ?? $stock_in->sale_order_other }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                                    ...
                                                    @foreach ($stock_products as $key => $stock_product)
                                                        <tr>
                                                            ...
                                                            <td><input type="hidden" class="hiddenId"
                                                                    ...
                                                                    type="button" class="btn btn-primary openModal mr-2"
                                                                    data-toggle="modal"
                                                                    data-target="#exampleModal">+</button><button
                                                                    type="button"
