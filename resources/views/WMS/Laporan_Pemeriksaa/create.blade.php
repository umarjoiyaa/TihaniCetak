                                    ...
                                    <table class="table table-bordered mt-5">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center d-flex justify-content-center"><input type="checkbox" name="" id="" ></td>
                                            </tr>
                                            <tr>
                    ...
                    <div class="card"  style="background:#f6f7f7;">
                        <div class="card-body">
                            ...
                            <div class="table-reponsive">
                                ...
                                <a href="{{route('Laporan_Pemeriksaan.senarai')}}" class="btn btn-primary float-right mt-3">Rekod Pemeriksaan AQL</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 mt-5"><h5>Bungkusan</h5></div>
                                </div>
