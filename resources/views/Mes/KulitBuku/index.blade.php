                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title tx-20 mg-b-0 p-2">LAPORAN PEMERIKSAAN KUALITI - PEMOTONGAN KULIT BUKU/TEKS</h4>
                        </div>

                    </div>
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('kulit_buku.create') }}" class="btn btn-primary mb-2">Create</a>
                        </div>
...
@push('custom-scripts')
    <script>
        var data = "{{ route('kulit_buku.data') }}";
    </script>
    <script src="{{ asset('assets/js/custom/mes/KulitBuku/index.js') }}"></script>
@endpush
