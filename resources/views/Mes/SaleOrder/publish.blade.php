                                ...
                                <div class="col-md-6 float-left">
                                    <div class="row">
                                        <div class="col-md-1 mt-4">
                                            ...
                                            download="{{ asset('/soft_copy/') }}/{{ $sale_order->soft_copy }}" title="Download Soft Copy" @endif
                                                class="btn btn-secondary"><i class="fa fa-download"></i></a>
                                        </div>
                                    </div>
