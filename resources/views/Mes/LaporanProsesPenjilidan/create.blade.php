...
<div class="row">
    <div class="col-md-12">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="checkbox" class="Cover1"
                                            onchange="handleCheckboxChange('Cover',this)" name="" id=""></td>
                                    <td><input type="checkbox" class="Cover1"
                                ...
                                <tr>
                                    ...
                                    <td><input type="checkbox" class="Text8"
                                            onchange="handleCheckboxChange('Text8',this)" checked name="" id=""></td>
                                    <td><input type="checkbox" class="Text8"
                                            onchange="handleCheckboxChange('Text8',this)" name="" id=""></td>
                                </tr>
                            </tbody>
        ...
        <a href="{{route('LaporanProsesPenjilidan')}}">back to list</a>
