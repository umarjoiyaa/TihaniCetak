            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date" value="{{ $laporan_proses_three->date }}"
                        ...
                        <form action="{{ route('laporan_proses_three.approve.approve', $laporan_proses_three->id) }}"
