        ...
        <div class="card mt-5">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <h6 class="card-title tx-20 mg-b-0 p-2"><b>LAPORAN PEMERIKSAAN KUALITI - PEMOTONGAN KULIT BUKU/
                            TEKS</b></h6>
                </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu tx-13">
                                            <a class="dropdown-item"
                                                href="{{route('ProsesPemotonganKulitBuku.view')}}">View</a>
                                            <a class="dropdown-item"
                                                href="{{route('ProsesPemotonganKulitBuku.edit')}}">Edit</a>
                                            <a class="dropdown-item"
                                                href="{{route('ProsesPemotonganKulitBuku.verify')}}">Verify</a>
