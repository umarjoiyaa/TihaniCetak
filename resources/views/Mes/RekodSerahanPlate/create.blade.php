                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="" name="seksyen_no"
                                                    id="" class="form-control" value="{{ old('seksyen_no') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4 mt-3">
                                            <div class="form-group">
                                                <div class="label">Kuaniti Plate.</div>
                                                <input type="text" value="" name="kuaniti_plate"
                                                    id="" class="form-control" value="{{ old('kuaniti_plate') }}">
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-5">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Dummy Lipat</td>
                                                <td><input type="checkbox" name="dummy_lipat" id="" value="ok">
                                                </td>
                                                <td><input type="checkbox" checked name="dummy_lipat" value="ng"
                                                        id=""></td>
                                            </tr>
                                            <tr>
                                                <td>Sample</td>
                                                <td><input type="checkbox" name="sample" id="" value="ok">
                                                </td>
                                                <td><input type="checkbox" checked name="sample" id=""
                                                        value="ng"></td>
                                            </tr>
                                        </tbody>
                                    </table>
