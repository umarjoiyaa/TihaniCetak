                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        ...
                                        <input type="text" value="{{ $rekod_serahan_plate->user->full_name }}" readonly id=""
                                            class="form-control">
                                    </div>
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <div class="label">Diterima Oleh</div>
                                            <input type="text" value="{{ $rekod_serahan_plate->operator->full_name }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly name="seksyen_no"
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly name="kuaniti_plate"
                                                id="" class="form-control"
                                                value="{{ $rekod_serahan_plate->kuaniti_plate }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly id="status" value="{{ $rekod_serahan_plate->sale_order->status }}" class="form-control">
                                        </div>
                                    </div>
