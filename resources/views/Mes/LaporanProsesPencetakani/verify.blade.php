                                ...
                                <div class="row">
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="date" disabled value="{{ \Carbon\Carbon::parse($laporan_proses_pencetakani->date)->format('d-m-Y') }}" class="form-control" id="datepicker" pattern="\d{2}-\d{2}-\d{4}" placeholder="dd-mm-yyyy">
