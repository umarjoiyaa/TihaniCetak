                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="Book title" readonly name="" id=""
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly value="CP-XXXX" name="" id=""
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4 mt-4">
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="3" readonly placeholder="User Input" name="" id="" class="form-control">
                                    </div>
                                </div>
                            </div>
