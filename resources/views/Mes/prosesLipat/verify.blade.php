                        ...
                        <div class="row">
                            <div class="col-md-4 mt-4">
                                <div class="form-group">
                                    ...
                                    <select name="" id="" readonly class="form-control form-select">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-4">
                                <div class="form-group">
                                    ...
                                    <select name="" id="" readonly class="form-control form-select">
                                        <option value="">pilih Jenis Lipat</option>
                            ...
                            <div class="col-md-4 mt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly placeholder="User Input" value="3" name="" id=""
                                        class="form-control">
                                </div>
                            </div>
                        </div>
