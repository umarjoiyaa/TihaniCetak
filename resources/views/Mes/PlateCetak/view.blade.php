            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" value="Cp 2940" readonly name="" id="" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for=""></label>
                            <input type="number" value="2" readonly name="" id="" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                        ...
                        <table class="table" border="1">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="checkbox" name="" id=""></td>
                                    <td><input type="text" readonly value="28" name="" id="" class="form-control"></td>
                                    <td><input type="text" readonly value="8" name="" id="" class="form-control"></td>
                                    <td><input type="text" readonly value="83" name="" id="" class="form-control"></td>
                                    <td><input type="checkbox" name="" id=""></td>
                                    <td><input type="checkbox" name="" id=""></td>
                                    <td><input type="checkbox" name="" id=""></td>
                                </tr>
                        ...
                        <table class="table" border='1'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>455</td>
                                    <td class="text-center">1. Tambahan 5mm gripper margin jika cetakan ada hotstamping
