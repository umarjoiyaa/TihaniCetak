                            ...
                            <div class="row">
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="date"
                                            value="{{ \Carbon\Carbon::parse($proses_pencetakan->date)->format('d-m-Y') }}"
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $proses_pencetakan->user->user_name }}" readonly name=""
                                    ...
                                    <table class="table" border="1">
                                        ...
                                        <tbody>
                                            <tr style="background:wheat;">
                                                ...
                                                <td><input type="checkbox" class="Cover1"
                                                        onchange="handleCheckboxChange('Cover1',this)" name="b_1"
                                                        value="na" id="" @checked($proses_pencetakan->b_1 == 'na')></td>
                                            ...
                                            <tr style="background:wheat;">
                                                ...
                                                <td><input type="checkbox" class="Text1"
                                                        ...
                                                        value="ok" id="" @checked($proses_pencetakan->b_2 == 'ok')></td>
                                                <td><input type="checkbox" class="Text1"
                                                        onchange="handleCheckboxChange('Text1',this)" name="b_2"
                                                        value="ng" id="" @checked($proses_pencetakan->b_2 == 'ng')></td>
                                                <td><input type="checkbox" class="Text1"
                                                        onchange="handleCheckboxChange('Text1',this)" name="b_2"
                                                        value="na" id="" @checked($proses_pencetakan->b_2 == 'na')></td>
                                            ...
                                            <tr style="background:wheat;">
                                                ...
                                                <td><input type="checkbox" class="Cover2"
                                                        ...
                                                        value="ok" id="" @checked($proses_pencetakan->b_3 == 'ok')></td>
                                                <td><input type="checkbox" class="Cover2"
                                                        onchange="handleCheckboxChange('Cover2',this)" name="b_3"
                                                        value="ng" id="" @checked($proses_pencetakan->b_3 == 'ng')></td>
                                                <td><input type="checkbox" class="Cover2"
                                                        onchange="handleCheckboxChange('Cover2',this)" name="b_3"
                                                        value="na" id="" @checked($proses_pencetakan->b_3 == 'na')></td>
                                            ...
                                            <tr style="background:wheat;">
                                                ...
                                                <td><input type="checkbox" class="Text2"
                                                        ...
                                                        value="ok" id="" @checked($proses_pencetakan->b_4 == 'ok')></td>
                                                <td><input type="checkbox" class="Text2"
                                                        onchange="handleCheckboxChange('Text2',this)" name="b_4"
                                                        value="ng" id="" @checked($proses_pencetakan->b_4 == 'ng')></td>
                                                <td><input type="checkbox" class="Text2"
                                                        onchange="handleCheckboxChange('Text2',this)" name="b_4"
                                                        value="na" id="" @checked($proses_pencetakan->b_4 == 'na')></td>
                                            ...
                                            <tr style="background:wheat;">
                                                ...
                                                <td><input type="checkbox" class="Cover3"
                                                        ...
                                                        value="ok" id="" @checked($proses_pencetakan->b_5 == 'ok')></td>
                                                <td><input type="checkbox" class="Cover3"
                                                        onchange="handleCheckboxChange('Cover3',this)" name="b_5"
                                                        value="ng" id="" @checked($proses_pencetakan->b_5 == 'ng')></td>
                                                <td><input type="checkbox" class="Cover3"
                                                        onchange="handleCheckboxChange('Cover3',this)" name="b_5"
                                                        value="na" id="" @checked($proses_pencetakan->b_5 == 'na')></td>
                                            ...
                                            <tr style="background:wheat;">
                                                ...
                                                <td><input type="checkbox" class="Text3"
                                                        ...
                                                        value="ok" id="" @checked($proses_pencetakan->b_6 == 'ok')></td>
                                                <td><input type="checkbox" class="Text3"
                                                        onchange="handleCheckboxChange('Text3',this)" name="b_6"
                                                        value="ng" id="" @checked($proses_pencetakan->b_6 == 'ng')></td>
                                                <td><input type="checkbox" class="Text3"
                                                        onchange="handleCheckboxChange('Text3',this)" name="b_6"
                                                        value="na" id="" @checked($proses_pencetakan->b_6 == 'na')></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" class="Cover4"
                                                        ...
                                                        value="ok" id="" @checked($proses_pencetakan->b_7 == 'ok')></td>
                                                <td><input type="checkbox" class="Cover4"
                                                        onchange="handleCheckboxChange('Cover4',this)" name="b_7"
                                                        value="ng" id="" @checked($proses_pencetakan->b_7 == 'ng')></td>
                                                <td><input type="checkbox" class="Cover4"
                                                        onchange="handleCheckboxChange('Cover4',this)" name="b_7"
                                                        value="na" id="" @checked($proses_pencetakan->b_7 == 'na')></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" class="Text4"
                                                        ...
                                                        value="ok" id="" @checked($proses_pencetakan->b_8 == 'ok')></td>
                                                <td><input type="checkbox" class="Text4"
                                                        onchange="handleCheckboxChange('Text4',this)" name="b_8"
                                                        value="ng" id="" @checked($proses_pencetakan->b_8 == 'ng')></td>
                                                <td><input type="checkbox" class="Text4"
                                                        onchange="handleCheckboxChange('Text4',this)" name="b_8"
                                                        value="na" id="" @checked($proses_pencetakan->b_8 == 'na')></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" class="Cover5"
                                                        ...
                                                        value="ok" id="" @checked($proses_pencetakan->b_9 == 'ok')></td>
                                                <td><input type="checkbox" class="Cover5"
                                                        onchange="handleCheckboxChange('Cover5',this)" name="b_9"
                                                        value="ng" id="" @checked($proses_pencetakan->b_9 == 'ng')></td>
                                                <td><input type="checkbox" class="Cover5"
                                                        onchange="handleCheckboxChange('Cover5',this)" name="b_9"
                                                        value="na" id="" @checked($proses_pencetakan->b_9 == 'na')></td>
