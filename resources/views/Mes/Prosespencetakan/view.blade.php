                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly value="Book Title" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="label">Kod Buku</div>
                                    <input type="text" value="CP-XXXX" readonly name="" id="" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="N/A" readonly name="" id="" class="form-control">
                                </div>
                            </div>
