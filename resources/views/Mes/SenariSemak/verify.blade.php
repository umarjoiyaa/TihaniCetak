                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $senari_semak->user->user_name }}" readonly
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="checkbox" name="behagian_a_1_text" @checked($senari_semak->bahagian_a_1_text == 'ok')
                                                    value="ok"></td>
                                            <td><input type="checkbox" name="behagian_a_1_text" @checked($senari_semak->bahagian_a_1_text == 'ng')
                                                    value="ng">
                                            </td>
                                            <td><input type="checkbox" name="behagian_a_1_text" @checked($senari_semak->bahagian_a_1_text == 'na')
                                                    value="na"></td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            ...
                                            <td><input type="checkbox" name="behagian_a_2_text" @checked($senari_semak->bahagian_a_2_text == 'ok')
                                                    value="ok"></td>
