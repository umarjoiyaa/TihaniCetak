                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover12"
                                                onchange="handleCheckboxChange('Cover12',this)" name="behagian_a_10_text"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover13"
                                                onchange="handleCheckboxChange('Cover13',this)" name="behagian_b_1_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover15"
                                                onchange="handleCheckboxChange('Cover15',this)" name="behagian_b_2_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover17"
                                                onchange="handleCheckboxChange('Cover17',this)" name="behagian_b_3_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover19"
                                                onchange="handleCheckboxChange('Cover19',this)" name="behagian_b_4_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover21"
                                                onchange="handleCheckboxChange('Cover21',this)" name="behagian_b_5_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover23"
                                                onchange="handleCheckboxChange('Cover23',this)" name="behagian_b_6_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover25"
                                                onchange="handleCheckboxChange('Cover25',this)" name="behagian_b_7_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover27"
                                                onchange="handleCheckboxChange('Cover27',this)" name="behagian_b_8_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover29"
                                                onchange="handleCheckboxChange('Cover29',this)" name="behagian_b_9_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover32"
                                                onchange="handleCheckboxChange('Cover32',this)" name="behagian_b_10_text"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover34"
                                                onchange="handleCheckboxChange('Cover34',this)" name="behagian_b_11_text"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover35"
                                                onchange="handleCheckboxChange('Cover35',this)" name="behagian_c_1_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover37"
                                                onchange="handleCheckboxChange('Cover37',this)" name="behagian_c_2_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover39"
                                                onchange="handleCheckboxChange('Cover39',this)" name="behagian_c_3_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover41"
                                                onchange="handleCheckboxChange('Cover41',this)" name="behagian_c_4_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover43"
                                                onchange="handleCheckboxChange('Cover43',this)" name="behagian_c_5_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover45"
                                                onchange="handleCheckboxChange('Cover45',this)" name="behagian_c_6_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover47"
                                                onchange="handleCheckboxChange('Cover47',this)" name="behagian_c_7_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover49"
                                                onchange="handleCheckboxChange('Cover49',this)" name="behagian_c_8_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover51"
                                                onchange="handleCheckboxChange('Cover51',this)" name="behagian_c_9_cover"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover54"
                                                onchange="handleCheckboxChange('Cover54',this)" name="behagian_c_10_text"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover56"
                                                onchange="handleCheckboxChange('Cover56',this)" name="behagian_c_11_text"
