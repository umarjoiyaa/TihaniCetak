                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    ...
                                                    name="behagian_a_1_cover" @checked($senari_semak->bahagian_a_1_cover
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_1_cover" @checked($senari_semak->bahagian_a_1_cover
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_1_text" @checked($senari_semak->bahagian_a_1_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_1_text" @checked($senari_semak->bahagian_a_1_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_2_cover" @checked($senari_semak->bahagian_a_2_cover
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_2_cover" @checked($senari_semak->bahagian_a_2_cover
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_2_text" @checked($senari_semak->bahagian_a_2_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_2_text" @checked($senari_semak->bahagian_a_2_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_3_cover" @checked($senari_semak->bahagian_a_3_cover
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_3_cover" @checked($senari_semak->bahagian_a_3_cover
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_3_text" @checked($senari_semak->bahagian_a_3_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_3_text" @checked($senari_semak->bahagian_a_3_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_4_cover" @checked($senari_semak->bahagian_a_4_cover
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_4_cover" @checked($senari_semak->bahagian_a_4_cover
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_4_text" @checked($senari_semak->bahagian_a_4_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_4_text" @checked($senari_semak->bahagian_a_4_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_6_cover" @checked($senari_semak->bahagian_a_6_cover
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_6_cover" @checked($senari_semak->bahagian_a_6_cover
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_7_text" @checked($senari_semak->bahagian_a_7_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_7_text" @checked($senari_semak->bahagian_a_7_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_9_text" @checked($senari_semak->bahagian_a_9_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_a_9_text" @checked($senari_semak->bahagian_a_9_text
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_1_text" @checked($senari_semak->bahagian_b_1_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_1_text" @checked($senari_semak->bahagian_b_1_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_2_text" @checked($senari_semak->bahagian_b_2_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_2_text" @checked($senari_semak->bahagian_b_2_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_3_text" @checked($senari_semak->bahagian_b_3_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_3_text" @checked($senari_semak->bahagian_b_3_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_4_text" @checked($senari_semak->bahagian_b_4_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_4_text" @checked($senari_semak->bahagian_b_4_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_5_text" @checked($senari_semak->bahagian_b_5_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_5_text" @checked($senari_semak->bahagian_b_5_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_6_text" @checked($senari_semak->bahagian_b_6_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_6_text" @checked($senari_semak->bahagian_b_6_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_7_text" @checked($senari_semak->bahagian_b_7_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_7_text" @checked($senari_semak->bahagian_b_7_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_8_text" @checked($senari_semak->bahagian_b_8_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_8_text" @checked($senari_semak->bahagian_b_8_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_9_text" @checked($senari_semak->bahagian_b_9_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_9_text" @checked($senari_semak->bahagian_b_9_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_10_cover"
                                                    @checked($senari_semak->bahagian_b_10_cover == 'ok') value="ok">
                                            </td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_10_cover"
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_10_cover"
                                                    @checked($senari_semak->bahagian_b_10_cover == 'na') value="na">
                                            </td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_11_cover"
                                                    @checked($senari_semak->bahagian_b_11_cover == 'ok') value="ok">
                                            </td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_11_cover"
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_b_11_cover"
                                                    @checked($senari_semak->bahagian_b_11_cover == 'na') value="na">
                                            </td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_1_text" @checked($senari_semak->bahagian_c_1_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_1_text" @checked($senari_semak->bahagian_c_1_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_2_text" @checked($senari_semak->bahagian_c_2_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_2_text" @checked($senari_semak->bahagian_c_2_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_3_text" @checked($senari_semak->bahagian_c_3_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_3_text" @checked($senari_semak->bahagian_c_3_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_4_text" @checked($senari_semak->bahagian_c_4_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_4_text" @checked($senari_semak->bahagian_c_4_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_5_text" @checked($senari_semak->bahagian_c_5_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_5_text" @checked($senari_semak->bahagian_c_5_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_6_text" @checked($senari_semak->bahagian_c_6_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_6_text" @checked($senari_semak->bahagian_c_6_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_7_text" @checked($senari_semak->bahagian_c_7_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_7_text" @checked($senari_semak->bahagian_c_7_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_8_text" @checked($senari_semak->bahagian_c_8_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_8_text" @checked($senari_semak->bahagian_c_8_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_9_text" @checked($senari_semak->bahagian_c_9_text
                                                == 'ok') value="ok"></td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_9_text" @checked($senari_semak->bahagian_c_9_text
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_10_cover"
                                                    @checked($senari_semak->bahagian_c_10_cover == 'ok') value="ok">
                                            </td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_10_cover"
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_10_cover"
                                                    @checked($senari_semak->bahagian_c_10_cover == 'na') value="na">
                                            </td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_11_cover"
                                                    @checked($senari_semak->bahagian_c_11_cover == 'ok') value="ok">
                                            </td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_11_cover"
                                            ...
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
                                                    name="behagian_c_11_cover"
                                                    @checked($senari_semak->bahagian_c_11_cover == 'na') value="na">
                                            </td>
                                            <td><input type="checkbox" class="Cover1"
                                                    onchange="handleCheckboxChange('Cover1',this)"
