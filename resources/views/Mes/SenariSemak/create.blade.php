                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text1"
                                                onchange="handleCheckboxChange('Text1',this)" name="behagian_a_1_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text1"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover2"
                                                onchange="handleCheckboxChange('Cover2',this)" name="behagian_a_2_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover2"
                                        ...
                                        <td><input type="checkbox" class="Text2"
                                                onchange="handleCheckboxChange('Text2',this)" name="behagian_a_2_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text2"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover3"
                                                onchange="handleCheckboxChange('Cover3',this)" name="behagian_a_3_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover3"
                                        ...
                                        <td><input type="checkbox" class="Text3"
                                                onchange="handleCheckboxChange('Text3',this)" name="behagian_a_3_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text3"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover4"
                                                onchange="handleCheckboxChange('Cover4',this)" name="behagian_a_4_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover4"
                                        ...
                                        <td><input type="checkbox" class="Text4"
                                                onchange="handleCheckboxChange('Text4',this)" name="behagian_a_4_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text4"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover5"
                                                onchange="handleCheckboxChange('Cover5',this)" name="behagian_a_5_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover5"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text5"
                                                onchange="handleCheckboxChange('Text5',this)" name="behagian_a_6_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text5"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover6"
                                                onchange="handleCheckboxChange('Cover6',this)" name="behagian_a_7_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover6"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3"></td>
                                        <td colspan="3"><input type="type" class="form-control" value="input text"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text6"
                                                onchange="handleCheckboxChange('Text6',this)" name="behagian_a_9_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text6"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Cover7"
                                                onchange="handleCheckboxChange('Cover7',this)" name="behagian_a_10_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover7"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text7"
                                                onchange="handleCheckboxChange('Text7',this)" name="behagian_b_1_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text7"
                                        ...
                                        <td><input type="checkbox" class="Cover8"
                                                onchange="handleCheckboxChange('Cover8',this)" name="behagian_b_1_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover8"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text8"
                                                onchange="handleCheckboxChange('Text8',this)" name="behagian_b_2_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text8"
                                        ...
                                        <td><input type="checkbox" class="Cover9"
                                                onchange="handleCheckboxChange('Cover9',this)" name="behagian_b_2_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover9"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text9"
                                                onchange="handleCheckboxChange('Text9',this)" name="behagian_b_3_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text9"
                                        ...
                                        <td><input type="checkbox" class="Cover10"
                                                onchange="handleCheckboxChange('Cover10',this)" name="behagian_b_3_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover10"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text10"
                                                onchange="handleCheckboxChange('Text10',this)" name="behagian_b_4_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text10"
                                        ...
                                        <td><input type="checkbox" class="Cover11"
                                                onchange="handleCheckboxChange('Cover11',this)" name="behagian_b_4_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover11"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text11"
                                                onchange="handleCheckboxChange('Text11',this)" name="behagian_b_5_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text11"
                                        ...
                                        <td><input type="checkbox" class="Cover12"
                                                onchange="handleCheckboxChange('Cover12',this)" name="behagian_b_5_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover12"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text12"
                                                onchange="handleCheckboxChange('Text12',this)" name="behagian_b_6_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text12"
                                        ...
                                        <td><input type="checkbox" class="Cover13"
                                                onchange="handleCheckboxChange('Cover13',this)" name="behagian_b_6_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover13"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text13"
                                                onchange="handleCheckboxChange('Text13',this)" name="behagian_b_7_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text13"
                                        ...
                                        <td><input type="checkbox" class="Cover14"
                                                onchange="handleCheckboxChange('Cover14',this)" name="behagian_b_7_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover14"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text14"
                                                onchange="handleCheckboxChange('Text14',this)" name="behagian_b_8_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text14"
                                        ...
                                        <td><input type="checkbox" class="Cover15"
                                                onchange="handleCheckboxChange('Cover15',this)" name="behagian_b_8_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover15"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text15"
                                                onchange="handleCheckboxChange('Text15',this)" name="behagian_b_9_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text15"
                                        ...
                                        <td><input type="checkbox" class="Cover16"
                                                onchange="handleCheckboxChange('Cover16',this)" name="behagian_b_9_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover16"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text18"
                                                onchange="handleCheckboxChange('Text18',this)" name="behagian_c_1_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text18"
                                        ...
                                        <td><input type="checkbox" class="Cover19"
                                                onchange="handleCheckboxChange('Cover19',this)" name="behagian_c_1_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover19"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text19"
                                                onchange="handleCheckboxChange('Text19',this)" name="behagian_c_2_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text19"
                                        ...
                                        <td><input type="checkbox" class="Cover20"
                                                onchange="handleCheckboxChange('Cover20',this)" name="behagian_c_2_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover20"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text20"
                                                onchange="handleCheckboxChange('Text20',this)" name="behagian_c_3_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text20"
                                        ...
                                        <td><input type="checkbox" class="Cover21"
                                                onchange="handleCheckboxChange('Cover21',this)" name="behagian_c_3_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover21"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text21"
                                                onchange="handleCheckboxChange('Text21',this)" name="behagian_c_4_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text21"
                                        ...
                                        <td><input type="checkbox" class="Cover22"
                                                onchange="handleCheckboxChange('Cover22',this)" name="behagian_c_4_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover22"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text22"
                                                onchange="handleCheckboxChange('Text22',this)" name="behagian_c_5_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text22"
                                        ...
                                        <td><input type="checkbox" class="Cover23"
                                                onchange="handleCheckboxChange('Cover23',this)" name="behagian_c_5_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover23"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text23"
                                                onchange="handleCheckboxChange('Text23',this)" name="behagian_c_6_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text23"
                                        ...
                                        <td><input type="checkbox" class="Cover24"
                                                onchange="handleCheckboxChange('Cover24',this)" name="behagian_c_6_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover24"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text24"
                                                onchange="handleCheckboxChange('Text24',this)" name="behagian_c_7_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text24"
                                        ...
                                        <td><input type="checkbox" class="Cover25"
                                                onchange="handleCheckboxChange('Cover25',this)" name="behagian_c_7_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover25"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text25"
                                                onchange="handleCheckboxChange('Text25',this)" name="behagian_c_8_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text25"
                                        ...
                                        <td><input type="checkbox" class="Cover26"
                                                onchange="handleCheckboxChange('Cover26',this)" name="behagian_c_8_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover26"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" class="Text26"
                                                onchange="handleCheckboxChange('Text26',this)" name="behagian_c_9_cover"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Text26"
                                        ...
                                        <td><input type="checkbox" class="Cover27"
                                                onchange="handleCheckboxChange('Cover27',this)" name="behagian_c_9_text"
                                                value="ok"></td>
                                        <td><input type="checkbox" class="Cover27"
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col-md-7"><input type="text" width=""
                                                        placeholder="Text input" name="behagian_c_11_input" id=""
