                            ...
                            <div class="row">
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="date"
                                            value="{{ \Carbon\Carbon::parse($pengumpulan_gathering->date)->format('d-m-Y') }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $pengumpulan_gathering->sale_order->order_no }}"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $pengumpulan_gathering->sale_order->description }}"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $pengumpulan_gathering->sale_order->kod_buku }}"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <table class="table" border="1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" class="Cover1"
                                                        onchange="handleCheckboxChange('Cover1',this)" name="b_1"
                                                        value="ng" @checked($pengumpulan_gathering->b_1 == 'ng') id="">
                                                </td>
                                            </tr>
                                            <tr>
