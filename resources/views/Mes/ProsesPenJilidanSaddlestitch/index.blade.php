        ...
        <div class="card mt-5">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <h6 class="card-title tx-20 mg-b-0 p-2"><b>LAPORAN PEMERIKSAAN KUALITI - PROSES PENJILIDAN SADDLE
                            STITCH</b></h6>
                </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu tx-13">
                                            <a class="dropdown-item"
                                                href="{{route('ProsesPenJilidanSaddlestitch.view')}}">View</a>
                                            <a class="dropdown-item"
                                                href="{{route('ProsesPenJilidanSaddlestitch.edit')}}">Edit</a>
                                            <a class="dropdown-item"
                                                href="{{route('ProsesPenJilidanSaddlestitch.verify')}}">Verify</a>
