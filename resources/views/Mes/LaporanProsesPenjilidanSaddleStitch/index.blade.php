        ...
        <div class="card mt-5">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-end">
                    <a href="{{route('LaporanProsesPenjilidan(SaddleStitch).create')}}"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu tx-13">
                                            <a class="dropdown-item"
                                                href="{{route('LaporanProsesPenjilidan(SaddleStitch).view')}}">View</a>
                                            <a class="dropdown-item"
                                                href="{{route('LaporanProsesPenjilidan.edit')}}">Edit</a>
                                            <a class="dropdown-item"
                                                href="{{route('LaporanProsesPenjilidan(SaddleStitch).verify')}}">Verify</a>
