                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" class="Cover6"
                                                        onchange="handleCheckboxChange('Cover6',this)" name="" id="">
                                                </td>
                                                <td><input type="checkbox" class="Cover6"
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" class="Text6"
                                                        onchange="handleCheckboxChange('Text6',this)" name="" id="">
                                                </td>
                                                <td><input type="checkbox" class="Text6"
                                                        onchange="handleCheckboxChange('Text6',this)" checked name=""
                                                        id=""></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" class="Cover7"
                                                        onchange="handleCheckboxChange('Cover7',this)" name="" id="">
                                                </td>
                                                <td><input type="checkbox" class="Cover7"
