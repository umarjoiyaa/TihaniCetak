                                        ...
                                        <div class="col-md-4 mt-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="date"
                                                    value="{{ $laporan_pemeriksaan_kualiti_penjilidan->date }}" id="Currentdate"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4 mt-3">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="checkbox" class="Cover1"
                                                                ...
                                                                name="b_1" value="ok" @checked($laporan_pemeriksaan_kualiti_penjilidan->b_1 == 'ok')
                                                                id=""></td>
                                                        <td><input type="checkbox" class="Cover1"
                                                                onchange="handleCheckboxChange('Cover1',this)"
                                                                name="b_1" value="ng" @checked($laporan_pemeriksaan_kualiti_penjilidan->b_1 == 'ng')
                                                                id=""></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><input type="checkbox" class="Text1"
                                                                ...
                                                                name="b_2" value="ng" @checked($laporan_pemeriksaan_kualiti_penjilidan->b_2 == 'ng')
                                                                id="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><input type="checkbox" class="Cover2"
                                                                ...
                                                                name="b_3" value="ok" @checked($laporan_pemeriksaan_kualiti_penjilidan->b_3 == 'ok')
                                                                id=""></td>
                                                        <td><input type="checkbox" class="Cover2"
                                                                onchange="handleCheckboxChange('Cover2',this)"
                                                                name="b_3" value="ng" @checked($laporan_pemeriksaan_kualiti_penjilidan->b_3 == 'ng')
                                                                id=""></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><input type="checkbox" class="Text2"
                                                                ...
                                                                name="b_4" value="ok" @checked($laporan_pemeriksaan_kualiti_penjilidan->b_4 == 'ok')
                                                                id=""></td>
                                                        <td><input type="checkbox" class="Text2"
                                                                onchange="handleCheckboxChange('Text2',this)"
                                                                name="b_4" value="ng" @checked($laporan_pemeriksaan_kualiti_penjilidan->b_4 == 'ng')
                                                                id="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><input type="checkbox" class="Cover3"
                                                                ...
                                                                name="b_5" value="ok"
                                                                @checked($laporan_pemeriksaan_kualiti_penjilidan->b_5 == 'ok') id=""></td>
                                                        <td><input type="checkbox" class="Cover3"
                                                                onchange="handleCheckboxChange('Cover3',this)"
                                                                name="b_5" value="ng"
                                                                @checked($laporan_pemeriksaan_kualiti_penjilidan->b_5 == 'ng') id=""></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><input type="checkbox" class="Text3"
                                                                ...
                                                                name="b_6" value="ok"
                                                                @checked($laporan_pemeriksaan_kualiti_penjilidan->b_6 == 'ok') id=""></td>
                                                        <td><input type="checkbox" class="Text3"
                                                                onchange="handleCheckboxChange('Text3',this)"
                                                                name="b_6" value="ng"
                                                                @checked($laporan_pemeriksaan_kualiti_penjilidan->b_6 == 'ng') id="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Koyak</td>
                                                        <td><input type="checkbox" class="Text3"
                                                                onchange="handleCheckboxChange('Text3',this)"
                                                                name="b_7" value="ok"
                                                                @checked($laporan_pemeriksaan_kualiti_penjilidan->b_7 == 'ok') id=""></td>
                                                        <td><input type="checkbox" class="Text3"
                                                                onchange="handleCheckboxChange('Text3',this)"
                                                                name="b_7" value="ng"
                                                                @checked($laporan_pemeriksaan_kualiti_penjilidan->b_7 == 'ng') id="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Kotor</td>
                                                        <td><input type="checkbox" class="Text3"
                                                                onchange="handleCheckboxChange('Text3',this)"
                                                                name="b_8" value="ok"
                                                                @checked($laporan_pemeriksaan_kualiti_penjilidan->b_8 == 'ok') id=""></td>
                                                        <td><input type="checkbox" class="Text3"
                                                                onchange="handleCheckboxChange('Text3',this)"
                                                                name="b_8" value="ng"
                                                                @checked($laporan_pemeriksaan_kualiti_penjilidan->b_8 == 'ng') id="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Pematuhan SOP</td>
                                                        <td><input type="checkbox" class="Text3"
                                                                onchange="handleCheckboxChange('Text3',this)"
                                                                name="b_9" value="ok"
                                                                @checked($laporan_pemeriksaan_kualiti_penjilidan->b_9 == 'ok') id=""></td>
                                                        <td><input type="checkbox" class="Text3"
                                                                onchange="handleCheckboxChange('Text3',this)"
                                                                name="b_9" value="ng"
                                                                @checked($laporan_pemeriksaan_kualiti_penjilidan->b_9 == 'ng') id="">
                                                        </td>
                                                    </tr>
