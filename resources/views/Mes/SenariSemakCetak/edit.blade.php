                                ...
                                @foreach ($detail2 as $key => $bahagian_c)
                                    <tr
                                        ...
                                        @php
                                                ...
                                                $rowCounter = 1;
                                        @endphp
                                        <td><input type="checkbox" name="bahagianC[{{ $key + 1 }}][1]" class="Cover0{{ $key + 1}}"
                                        ...
                                        <td><input type="checkbox" name="bahagianC[{{ $key + 1 }}][2]" class="text0{{$key + 1 }}"
                                        ...
                                        <td><input type="checkbox" name="bahagianC[{{ $key + 1 }}][3]" class="Endpaper0{{ $key + 1 }}"
                                        ...
                                        <td><input type="checkbox" name="bahagianC[{{ $key + 1 }}][4]" class="Cover01{{$key + 1 }}"
                                        ...
                                        <td><input type="checkbox" name="bahagianC[{{ $key + 1 }}][5]" class="text01{{ $key + 1 }}"
