                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('senari_semak_cetak.create') }}" class="btn btn-primary mb-2">Create</a>
                        </div>
...
@push('custom-scripts')
    <script>
        var data = "{{ route('senari_semak_cetak.data') }}";
    </script>
    <script src="{{ asset('assets/js/custom/mes/SenariSemakCetak/index.js') }}"></script>
@endpush
