                            ...
                            <table class="table mt-2" id="example1">
                                ...
                                <tbody>
                                    <tr class="">
                                        ...
                                        <td><span style="background:yellow; padding:5px; border:1px solid yellow; border-radius:5px; font-size:7px;">in-Progress</span></td>
                                        <td><div class="dropdown">
                                            <button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-primary"
                                            data-toggle="dropdown" id="dropdownMenuButton" type="button">Action<i class="fas fa-caret-down ml-1"></i></button>
                                            <div  class="dropdown-menu tx-13">
                                                <a class="dropdown-item" href="{{route('LaporanProsesThreeKnife.view')}}">View</a>
                                                <a class="dropdown-item" href="{{route('LaporanProsesThreeKnife.edit')}}">Edit</a>
                                                <a class="dropdown-item" href="{{route('LaporanProsesThreeKnife.verify')}}">Verify</a>
