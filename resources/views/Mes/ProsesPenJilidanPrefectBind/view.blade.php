...
<div class="container">
    <div class="row">
                    ...
                    <div class="card" style="background:#f1f0f0;">
                        <div class="card-body">
                            ...
                            <diiv class="row">
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="IQRO' GENIUUS RUMI (New Cover)" readonly name="" id=""
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly value="CP 2490" name="" id=""
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4 mt-4">
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly value="4" name="" id=""
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2"
                                    style="background:wheat; margin-top:150px; width:80px; height:150px; padding:5px 5px;">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="{{route('ProsesPenJilidanPrefectBind.index')}}"><i class="ti-angle-left mr-5 $indigo-100"></i>
                    back to list</a>
            </div>
        </div>
    </div>
