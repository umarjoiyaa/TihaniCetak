            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="float-left"><b>BORANG SERAH KERJA (TEKS)- Transfer</b></h5>
                                <p class="float-right">TCSB-B34 (Rev. 2)</p>
                            </div>
                        </div>

                        <form action="{{ route('borange_serah_kerja_teks.transfer.approve', $borange_serah_kerja_teks->id) }}" method="post">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea  id="" class="form-control" cols="30" rows="1" name="transfer_by_remarks"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
