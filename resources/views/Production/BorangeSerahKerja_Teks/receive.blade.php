            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="float-left"><b>BORANG SERAH KERJA (TEKS)- Receive</b></h5>
                                <p class="float-right">TCBS-B34 (Rev. 2)</p>
                            </div>
                        </div>

                        <form action="{{ route('borange_serah_kerja_teks.receive.approve', $borange_serah_kerja_teks->id) }}" method="post">
                            @csrf
