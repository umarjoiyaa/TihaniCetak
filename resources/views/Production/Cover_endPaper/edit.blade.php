                        ...
                        <div class="card-body">
                            <div class="row mt-2">
                                ...
                                <div class="col-md-4 ">
                                    ...
                                    <input type="text" readonly name="" value="{{ Auth::user()->full_name }}" class="form-control">
                                </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly name="kuantiti_waste" value="{{ $cover_end_paper->kuantiti_waste }}" id="" class="form-control">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="jenis" id="printCutSelect1" class="form-control form-select">
                                            ...
                                            <option value="Others" id="selectBox1" @selected($cover_end_paper->jenis == "Others")>Others</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kertas" value="{{ $cover_end_paper->kertas }}" id="" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="label">Saiz Potong:</div>
                                        <input type="text" name="saiz_potong" value="{{ $cover_end_paper->saiz_potong }}" id="" class="form-control">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row ">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="row mt-4 ">
                                                    <div class="col-md-1"><input type="checkbox" class="checkbox" name="front" @checked($cover_end_paper->front == "on")   id=""></div>
                                                    <div class="col-md-2">Front</div>
                                                    <div class="col-md-1"><input type="checkbox" class="checkbox" name="back" @checked($cover_end_paper->back == "on")   id=""></div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="waste_paper" value="{{ $cover_end_paper->waste_paper }}" id="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-4 ">
                                            ...
                                            <select name="print_cut" id="printSelect" class="form-control form-select">
                                                ...
                                                <option value="Others" @selected($cover_end_paper->print_cut == "Others") id="newInputOption">Others</option>
                                            </select>
                                        </div>

                                        <div class="col-md-4 ">
                                            <label for="">last Print</label>
                                            <input type="text" name="last_print" value="{{ $cover_end_paper->last_print }}" id=""
                                                class="form-control">
                                        </div>
                                        <div class="col-md-4 ">
                                            <label for=""></label>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" readonly name="" id="status" class="form-control">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="">Plate</label>
                                            <select name="plate" id="plate1" class="form-control form-select">
                                                <option value="Plate lama" @selected($cover_end_paper->plate == "Plate lama")>Plate lama</option>
                                                <option value="Plate baru" @selected($cover_end_paper->plate == "Plate baru")>Plate baru</option>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="">Saiz Produk</label>
                                            <input type="text" readonly name="" id="saiz_produk" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-7">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_1" id="Print3" @checked($cover_end_paper->finishing_1 == "on") class=" mr-5"
                                                                style="font-size:14px;">UV+Texture
                                                            Emboss <input type="text"
                                                                name="finishing_input_1" id="input1" @disabled($cover_end_paper->finishing_input_1 == null) value="{{ $cover_end_paper->finishing_input_1 }}" class="form-control float-right"
                                                                style="width:150px;">
                                                        </td>
                                                        <td>
                                                            <select name="finishing_supplier_1" id="print3" @disabled($cover_end_paper->finishing_1 == null)
                                                                class="form-control form-select" style="width:250px;">
                                                                <option value="In-house" @selected($cover_end_paper->finishing_supplier_1 == "In-house")>In-house</option>
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_2" @checked($cover_end_paper->finishing_2 == "on") id="Print4"
                                                                class=" mr-5">Gloss
                                                            Lamination</td>
                                                        <td><select name="finishing_supplier_2" @disabled($cover_end_paper->finishing_2 == null)  id="print4"
                                                                class="form-control form-select">
                                                                <option value="In-house" @selected($cover_end_paper->finishing_supplier_2 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_3" @checked($cover_end_paper->finishing_3 == "on") id="Print5"
                                                                class=" mr-5">Matt
                                                            Lamination</td>
                                                        <td><select name="finishing_supplier_3" @disabled($cover_end_paper->finishing_3 == null)  id="print5"
                                                                class="form-control form-select">
                                                                <option value="In-house" @selected($cover_end_paper->finishing_supplier_3 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_4" @checked($cover_end_paper->finishing_4 == "on") id="Print6"
                                                                class=" mr-5">Spot
                                                            UV
                                                        </td>
                                                        <td><select name="finishing_supplier_4" @disabled($cover_end_paper->finishing_4 == null)  id="print6"
                                                                class="form-control form-select">
                                                               <option value="In-house" @selected($cover_end_paper->finishing_supplier_4 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_5" @checked($cover_end_paper->finishing_5 == "on") id="Print7"
                                                                class=" mr-5">Spot
                                                            Miraval
                                                        </td>
                                                        <td><select name="finishing_supplier_5" @disabled($cover_end_paper->finishing_5 == null)  id="print7"
                                                                class="form-control form-select">
                                                               <option value="In-house" @selected($cover_end_paper->finishing_supplier_5 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_6" @checked($cover_end_paper->finishing_6 == "on") id="Print8" class=" mr-5">Hot
                                                            Stamping
                                                            <input type="text"  @disabled($cover_end_paper->finishing_6 == null) name="finishing_input_2"
                                                                id="input2" value="{{ $cover_end_paper->finishing_input_2 }}"    class="form-control float-right w-50">
                                                        </td>
                                                        <td><select name="finishing_supplier_6" @disabled($cover_end_paper->finishing_6 == null)  id="print8"
                                                                class="form-control form-select">
                                                                <option value="In-house" @selected($cover_end_paper->finishing_supplier_6 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_7" @checked($cover_end_paper->finishing_7 == "on") id="Print9"
                                                                class=" mr-5">Emboss
                                                        </td>
                                                        <td><select name="finishing_supplier_7" @disabled($cover_end_paper->finishing_7 == null) disabled id="print9"
                                                                class="form-control form-select">
                                                                <option value="In-house" @selected($cover_end_paper->finishing_supplier_7 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_8" @checked($cover_end_paper->finishing_8 == "on") id="Print10"
                                                                class=" mr-5">Deboss
                                                        </td>
                                                        <td><select name="finishing_supplier_8" @disabled($cover_end_paper->finishing_8 == null)  id="print10"
                                                                class="form-control form-select">
                                                               <option value="In-house" @selected($cover_end_paper->finishing_supplier_8 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_9" @checked($cover_end_paper->finishing_9 == "on") id="Print11" class=" mr-5">UV
                                                            Vanish
                                                        </td>
                                                        <td><select name="finishing_supplier_9" disabled id="print11"
                                                                class="form-control form-select">
                                                               <option value="In-house" @selected($cover_end_paper->finishing_supplier_9 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_10 " @checked($cover_end_paper->finishing_10 == "on") id="Print12"
                                                                class=" mr-5">Spot
                                                            corse UV
                                                        </td>
                                                        <td><select name="finishing_supplier_10" disabled id="print12"
                                                                class="form-control form-select">
                                                               <option value="In-house" @selected($cover_end_paper->finishing_supplier_10 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_11" @checked($cover_end_paper->finishing_11 == "on")  id="Print13"
                                                                class=" mr-5">Creasing
                                                            line
                                                        </td>
                                                        <td><select name="finishing_supplier_11" @disabled($cover_end_paper->finishing_11 == null) disabled id="print13"
                                                                class="form-control form-select">
                                                               <option value="In-house" @selected($cover_end_paper->finishing_supplier_11 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_12" @checked($cover_end_paper->finishing_12 == "on")  id="Print14"
                                                                class=" mr-5">Die
                                                            Cut
                                                        </td>
                                                        <td><select name="finishing_supplier_12" @disabled($cover_end_paper->finishing_12 == null)  id="print14"
                                                                class="form-control form-select">
                                                               <option value="In-house" @selected($cover_end_paper->finishing_supplier_12 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_13" @checked($cover_end_paper->finishing_13 == "on") id="Print15"
                                                                class=" mr-5">Perforation
                                                        </td>
                                                        <td><select name="finishing_supplier_13" @disabled($cover_end_paper->finishing_13 == null)  id="print15"
                                                                class="form-control form-select">
                                                               <option value="In-house" @selected($cover_end_paper->finishing_supplier_13 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_14" @checked($cover_end_paper->finishing_14 == "on") id="Print16"
                                                                class=" mr-5">Numbering
                                                        </td>
                                                        <td><select name="finishing_supplier_14" @disabled($cover_end_paper->finishing_14 == null)  id="print16"
                                                                class="form-control form-select">
                                                               <option value="In-house" @selected($cover_end_paper->finishing_supplier_14 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_15" @checked($cover_end_paper->finishing_15 == "on") id="Print17"
                                                                class=" mr-5">Punch
                                                            Hole
                                                        </td>
                                                        <td><select name="finishing_supplier_15" @disabled($cover_end_paper->finishing_15 == null)  id="print17"
                                                                class="form-control form-select">
                                                               <option value="In-house" @selected($cover_end_paper->finishing_supplier_15 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_16"  @checked($cover_end_paper->finishing_16 == "on") id="Print18"
                                                                class=" mr-5">Round
                                                            Corner
                                                        </td>
                                                        <td><select name="finishing_supplier_16" @disabled($cover_end_paper->finishing_16 == null)  id="print18"
                                                                class="form-control form-select">
                                                               <option value="In-house" @selected($cover_end_paper->finishing_supplier_16 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="finishing_17" @checked($cover_end_paper->finishing_17 == "on") id="Print19" class=" mr-5">
                                                            Others:
                                                            <input type="text" value="{{ $cover_end_paper->finishing_input_3 }}"  name="finishing_input_3"
                                                                id="input" class="form-control w-50 float-right">
                                                        </td>
                                                        <td><select name="finishing_supplier_17" @disabled($cover_end_paper->finishing_17 == null)  id="print19"
                                                                class="form-control form-select">
                                                               <option value="In-house" @selected($cover_end_paper->finishing_supplier_17 == "In-house")>In-house</option>
                                                                @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
