                                ...
                                <<div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="650 x 450" placeholder="User Input" readonly
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-4">
                                    ...
                                    <input type="text" value="REPEAT" readonly name="" id=""
                                        class="form-control">
                                </div>
                                <div class="col-md-4 mt-4">
                                ...
                                <div class="col-md-4 mt-4">
                                    ...
                                    <input type="text" value="15 X 21" readonly name="" id=""
                                        class="form-control">
                                </div>
                            </div>
                        </div>
