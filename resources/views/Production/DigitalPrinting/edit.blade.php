                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$digital_printing->jumlah_mukasurat}}" name="jumlah_mukasurat" id="jumlah"
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{$digital_printing->kuantiti_waste}}" name="kuantiti_waste" id="" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="mesin" id="Mesin1" class="form-control form-select">
                                                <option @selected($digital_printing->mesin == 'REVORIA SC170 FUJIFIILM') value="REVORIA SC170 FUJIFIILM">REVORIA SC170 FUJIFIILM</option>
                                                <option @selected($digital_printing->mesin == 'OTHERS') value="OTHERS" id="selectBox">Others</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4 mt-2">
                                        <div class="form-group">
                                            ...
                                            <select name="kategori_job" id="kategori1" class="form-select form-control">
                                                ...
                                                <option value="PENEGELUAREN" @selected($digital_printing->kategori_job == 'PENEGELUAREN')>PENEGELUAREN</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="jenis_produk" id="printCutSelect1"
                                                ...
                                                <option value="BUSINESS CARD" @selected($digital_printing->jenis_produk == 'BUSINESS CARD')>BUSINESS CARD</option>
                                                ...
                                                <option value="OTHERS" id="selectBox1" @selected($digital_printing->jenis_produk == 'OTHERS')>OTHERS</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kertas_teks" id=""
                                                class="form-control" value="{{$digital_printing->kertas_teks}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
