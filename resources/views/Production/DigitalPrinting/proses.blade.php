                    ...
                    <div class="card" style="background:#f1f0f0;">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 ">
                                    <button type="button" class="btn btn-light w-100" style="border:1px solid black;"><i
                                            class="la la-play" style="font-size:20px;"></i>Start</button>
                                </div>
                                <div class="col-md-4">
                                    <button type="button" class="btn  w-100" style="border:1px solid black;"><i
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly name=""
                                            value="{{ $digital_printing->sale_order->sale_order_no }}" id=""
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4 mt-3">
