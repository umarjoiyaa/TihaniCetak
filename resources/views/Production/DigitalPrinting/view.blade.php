                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="5000" readonly name="" id=""
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="196pp" readonly
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="interger input" value="200" readonly name="" id=""
                                                class="form-control">
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="" id="" readonly placeholder="Pilih Jenis produk" class="form-control">
                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><input type="checkbox" checked name="" id="" class=" mr-5">Matt
                                                        Lamination</td>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row mt-5">
                                            ...
                                            <div class="text-center">
                                                <h5><b>AMARAN</b></h5>
                                                <span>TIADA SAMPLE JANGAN CETAX</span><br>
                                                <span>FIRST PRICE JANGAN LUPA</span>
                                            </div>
                                            </div>
                                        </div>
                                    </div>
