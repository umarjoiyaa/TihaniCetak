                    ...
                    <div class="card" style="background:#f4f4ff;">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">Saiz Produk </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">Kuantiti SO</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">Jumlah mukasurat</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">Kuantiti Waste</label>
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-md-4 mt-2">
                                    <div class="form-group">
                                        <div class="form-label">Kategori job</div>
                                        <input type="text" class="form-control"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-label">Kertas: teks</div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-label">Kertas: Cover</div>
