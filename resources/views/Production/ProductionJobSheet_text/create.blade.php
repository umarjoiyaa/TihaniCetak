                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10 mt-3">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input type="date" name="" class="form-control" placeholder="date plan" id=""></td>
                                                    <td>
                                                    ...
                                                    <td><input type="text" name="" class="form-control" placeholder="USER INPUT" id=""></td>
                                                    <td><input type="text" name="" class="form-control" placeholder="USER INPUT" id=""></td>
                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><input type="checkbox" name="" id="" class=" mr-5">Hard Cover - Round Back</td>
                                                    <td><input type="text" name="" id="" class="form-control"></td>
                                                </tr>
                                                <tr>
