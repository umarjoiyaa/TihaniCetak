...
@section('content')
    <form action="{{ route('perfect_bind.update', $perfect_bind->id) }}" method="post">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="date" value="{{ $perfect_bind->date }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="sale_order" data-id="{{ $perfect_bind->sale_order_id }}"
                                                ...
                                                <option value="{{ $perfect_bind->sale_order_id }}" selected
                                                    ...
                                                    {{ $perfect_bind->sale_order->order_no }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly id="jumlah" class="form-control" name="jumlah">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="jenis" id="jenis" class="form-control form-select">
                                                ...
                                                <option value="GATHER" @selected($perfect_bind->jenis == 'GATHER')>GATHER</option>
                                            </select>
                                        </div>
                                    </div>
