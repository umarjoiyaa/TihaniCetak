            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Start date" name="" id="" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" placeholder="auto Display" name="" id="" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mt-5">
                                            <div class="col-md-12">
                                                <button class="btn btn-primary float-right"><i class="fa fa-magnifying-glass"></i>Search</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                            <button class="btn btn-primary float-right"><i class="fa fa-magnifying-glass"></i>download</button>
                            </div>
                        </div>
                    </div>
                </div>
