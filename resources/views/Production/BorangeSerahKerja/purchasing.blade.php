        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('borange_serah_kerja.purchasing.approve', $borange_serah_kerja->id) }}" method="POST"
                    ...
                    <!-- <div class="row">
                        ...
                        <div class="row d-flex justify-content-end mt-5">
                            <div class="col-md-12 d-flex justify-content-end">
                                ...
                                <form action="{{ route('borange_serah_kerja.purchasing.decline', $borange_serah_kerja->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
