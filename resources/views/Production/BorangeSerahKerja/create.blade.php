                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"><input type="text" placeholder="input text" name="" id=""
                    ...
                    <div class="card" style="background:#f1f0f0;">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-2"><input type="checkbox" name="" id=""><span
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3"><input type="text" placeholder="input text" name="" id=""
                                                class="form-control"></div>
                                    </div>
                                </div>
                            </div>
