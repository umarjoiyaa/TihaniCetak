        ...
        <div class="card ">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-end">
                    <a href="{{route('mesin_knife.create')}}" class="btn btn-primary mb-2">Create</a>
                </div>
...
@push('custom-scripts')
    <script>
        var data = "{{ route('mesin_knife.data') }}";
    </script>
    <script src="{{ asset('assets/js/custom/production/MesinKnife/index.js') }}"></script>
@endpush
