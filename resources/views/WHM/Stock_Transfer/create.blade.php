                ...
                <div class="card-body">
                    <div class="card" style="background:#f6f7f7;">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="Based User Login" readonly name="" id="" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly placeholder="User Input" name="" id="" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        <div class="label">Category </div>
                                        <input type="text" readonly placeHolder="userInput" name="" id="" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3"><h5>Customers</h5></div>
                                        <div class="col-md-8"><input type="text" readonly placeholder="select Customers" name="" id="" class="form-control"></div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                        <div class="col-md-1"><input type="checkbox" name="" id=""></div>
                                        <div class="col-md-3"><h5>Subcon</h5></div>
                                        <div class="col-md-8"><input type="text" readonly placeholder="select Customers" name="" id="" class="form-control"></div>
                                    </div>
                                </div>
                                <div class="col-md-6"></div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn-primary float-right mb-2" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">+ Add Product</button>
                                </div>
                            </div>
                            <div class="row">
                                        ...
                                        <table class="table mt-2" id="example1">
                                            ...
                                            <tbody>
                                               <tr>
                                                ...
                                                <td>REAM</td>
                                                <td></td>
                                                <td><button class="btn btn-primary" data-toggle="modal" data-target="#staticBackdrop1">+</button></td>
                                               </tr>
                                            </tbody>
                                        </table>
                                    </div>
